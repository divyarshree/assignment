...
<div class="owl-carousel owl-theme bls-blog">
    <?php 
        ...
        $args = array('post_type' => 'post', 'paged'=> $paged , 'order' => 'DESC' , 'posts_per_page' => -1 ,  'post_status' => 'publish',
					  'category_name' => 'blogs',
					  'meta_query' => array(
						array(
							'key'   => 'enable_on_homepage',
							'value' => '1',
						)
					)
					 );
...
add_shortcode('show_homeblog', 'program_homeblog');
?>