...
if(!function_exists('gavias_post_type_team')){
    function gavias_post_type_team(){
      $labels = array(
        'name' => __( 'Team', 'krowd-themer' ),
        'singular_name' => __( 'Team', 'krowd-themer' ),
        'add_new' => __( 'Add New Team', 'krowd-themer' ),
        'add_new_item' => __( 'Add New Team', 'krowd-themer' ),
        'edit_item' => __( 'Edit Team', 'krowd-themer' ),
        'new_item' => __( 'New Team', 'krowd-themer' ),
        'view_item' => __( 'View Team', 'krowd-themer' ),
        'search_items' => __( 'Search Teams', 'krowd-themer' ),
        'not_found' => __( 'No Teams found', 'krowd-themer' ),
        'not_found_in_trash' => __( 'No Teams found in Trash', 'krowd-themer' ),
        'parent_item_colon' => __( 'Parent Team:', 'krowd-themer' ),
        'menu_name' => __( 'Teams', 'krowd-themer' ),
      );
