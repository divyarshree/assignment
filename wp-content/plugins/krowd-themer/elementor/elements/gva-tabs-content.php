	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '#ffff',
				'selectors' => [
					'{{WRAPPER}} .gsc-tabs-content .nav_tabs > li.active a' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#18212e',
				'selectors' => [
					'{{WRAPPER}} .gsc-tabs-content .nav_tabs > li.active a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'tab_typography',
				'selector' => '{{WRAPPER}} .gsc-tabs-content .nav_tabs > li a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gsc-tabs-content .tab-content .tab-pane .tab-content-item' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gsc-tabs-content .tab-content .tab-pane .tab-content-item',
			]
		);
