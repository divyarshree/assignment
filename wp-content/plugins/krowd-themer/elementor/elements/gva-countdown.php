...
class GVAElement_Countdown extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Countdown', 'krowd-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'year',
			[
				'label' => __( 'Year', 'krowd-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => date('Y'),
				'placeholder' => __( 'ex: 2019', 'krowd-themer' ),
				'label_block' => true
			]
		);
		$this->add_control(
			'month',
			[
				'label' => __( 'Month', 'krowd-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '12',
				'placeholder' => __( 'ex: 12', 'krowd-themer' ),
			]
		);
		$this->add_control(
			'day',
			[
				'label' => __( 'Day', 'krowd-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '01',
				'placeholder' => __( 'ex: 01', 'krowd-themer' ),
			]
		);
		$this->add_control(
			'hour',
			[
				'label' => __( 'Hour', 'krowd-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '00',
				'placeholder' => __( 'ex: 00', 'krowd-themer' ),
			]
		);
		$this->add_control(
			'minutes',
			[
				'label' => __( 'Minutes', 'krowd-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '00',
				'placeholder' => __( 'ex: 00', 'krowd-themer' ),
			]
