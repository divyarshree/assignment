...
class GVAElement_User extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA User', 'krowd-themer' );
	}
	...
	protected function register_controls() {
      ...
      $this->add_control(
         'text_login',
         [
            'label'        => __( 'Text Sign in or Register', 'krowd-themer' ),
      ...
      $this->add_control(
         'text_login_url',
         [
            'label'        => __( 'Link Login Text', 'krowd-themer' ),
      ...
      $this->add_control(
		...
		$this->add_control(
			'menu_width',
			[
				'label' => __( 'Menu Width (px)', 'krowd-themer' ),
      ...
      $this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Account Menu', 'krowd-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
      $this->add_control(
