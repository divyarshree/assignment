<?php
function program_similiarinsightssection() {
    ob_start();
    $page = get_the_ID();
?>
<div class="blogs">
	<div class="eut-container">
		...
		<div class="col-12 col-sm-12 col-md-4 col-lg-4">
			<div class="search">
				 <input name="keywords" id="keywords" class="key mb-0" placeholder="Search"/>
			...
			<form action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="filters">
				<?php
					if( $terms = get_terms( array( 'taxonomy' => 'post_tag', 'orderby' => 'name','parent' => 0  ) ) ) : 
						...
						echo '<select name="tagfilter" id="tagfilter" class="fil mb-0"><option value="all">Filter By</option>';
	...
	<div class="blogs-se">
		<div class="row">
		 <?php 
            ...
            $args = array('post_type' => 'post', 'order' => 'DESC' ,  'post_status' => 'publish', 'posts_per_page' => 6,'paged' => $paged , 
						  'category_name' => 'blogs'
						 );
        ...
        ?>
		<div class="col-12 col-sm-12 col-md-4 col-lg-4 blogss kblog">
...
add_shortcode('show_similiarinsightssection', 'program_similiarinsightssection');
?>